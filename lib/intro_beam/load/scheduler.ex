defmodule IntroBeam.Load.Scheduler do
  # using this as base: https://github.com/sasa1977/demo_system/blob/master/load_control/lib/load_control/scheduler_monitor.ex
